                    ...
                    [
                        {
                            stack: [
                                ...
                                {text:company.crc, margin: [0,0,0,5]} //margem que define o espaço até à linha horizontal
                            ]
                        },
                        {
                            stack: [
                                {image: imagesURI[0].dataURI, width: (imagesURI[0].width* 1.6), alignment: 'right'}
                                //{text:"docName n.º xxxx/xxxx", alignment: 'right'}
                            ]
                        }
                    ...
                    [
                        {
                            stack: [
                                ...
                                {text:"NIF " + company.nif + " | Capital Social " + company.capSocial + " | " +company.crc, margin: [0,0,0,5]}
                            ]
                        },
                        {
                            stack: [
